...
class TradeDetail(BaseModel):
    ...
    data_context: Optional[List[Dict[str, Any]]] = Field(
        None, description="OHLCV data context around trade"
    )
...
class BacktestMetrics(BaseModel):
    ...
    avg_win: Optional[float] = Field(
        None, description="Average winning trade percentage"
    )
    avg_loss: Optional[float] = Field(
        None, description="Average losing trade percentage"
    )
...
class Backtest(BaseModel):
    ...
    trades: List[TradeDetail] = Field(
        default_factory=list, description="Individual trades"
    )
...
class BacktestExecution(BaseModel):
    ...
    completed_at: Optional[datetime] = Field(
        None, description="When backtest completed"
    )
