...
from fastapi import Depends, HTTPException, status, Request  # noqa: E402
...
from .crud.user import get_user_by_mongodb_id  # noqa: E402
...
def get_mongo_url():
    ...
    if local:
        ...
        if not password:
            raise ValueError(
                "MONGO_PASSWORD environment variable is required for Atlas connection"
            )
