...
class IndicatorConverter:
    """Converts strategy indicators to IndicatorFactory parameters"""
    
    def convert_indicators_to_params(self, indicators: List[Dict]) -> Dict:
    ...
    def validate_indicator_params(self, indicator: Dict) -> bool:
